...
InterruptManager::InterruptManager(uint16_t hwInterruptOffset, GlobalDescriptorTable* gdt, TaskManager* taskManager) : picMasterCommand(0x20), picMasterData(0x21), picSlaveCommand(0xA0), picSlaveData(0xA1) {
  ...
  SetInterruptDescriptorTableEntry(0x03, CodeSegment, &HandleException0x02, 0, IDT_INTERRUPT_GATE);
...
uint16_t InterruptManager::GetHwInterruptOffset() {
